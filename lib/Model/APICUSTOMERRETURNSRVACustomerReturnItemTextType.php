<?php
/**
 * APICUSTOMERRETURNSRVACustomerReturnItemTextType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APICUSTOMERRETURNSRVACustomerReturnItemTextType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnItemTextType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnItemTextType';
    ...
    */
    ...
    public function setCustomerReturn($customer_return)
    {
        ...
        if ((mb_strlen($customer_return) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_return when calling APICUSTOMERRETURNSRVACustomerReturnItemTextType., must be smaller than or equal to 10.');
        }
    ...
    public function setCustomerReturnItem($customer_return_item)
    {
        ...
        if ((mb_strlen($customer_return_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_item when calling APICUSTOMERRETURNSRVACustomerReturnItemTextType., must be smaller than or equal to 6.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling APICUSTOMERRETURNSRVACustomerReturnItemTextType., must be smaller than or equal to 2.');
        }
    ...
    public function setLongTextId($long_text_id)
    {
        ...
        if ((mb_strlen($long_text_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $long_text_id when calling APICUSTOMERRETURNSRVACustomerReturnItemTextType., must be smaller than or equal to 4.');
        }
