<?php
/**
 * APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnPrcgElmntType';
    ...
    */
    ...
    public function setCustomerReturn($customer_return)
    {
        ...
        if ((mb_strlen($customer_return) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_return when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 10.');
        }
    ...
    public function setPricingProcedureStep($pricing_procedure_step)
    {
        ...
        if ((mb_strlen($pricing_procedure_step) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_procedure_step when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setPricingProcedureCounter($pricing_procedure_counter)
    {
        ...
        if ((mb_strlen($pricing_procedure_counter) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_procedure_counter when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionType($condition_type)
    {
        ...
        if (!is_null($condition_type) && (mb_strlen($condition_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $condition_type when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 4.');
        }
    ...
    public function setPricingDateTime($pricing_date_time)
    {
        ...
        if (!is_null($pricing_date_time) && (mb_strlen($pricing_date_time) > 14)) {
            throw new \InvalidArgumentException('invalid length for $pricing_date_time when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 14.');
        }
    ...
    public function setConditionCalculationType($condition_calculation_type)
    {
        ...
        if (!is_null($condition_calculation_type) && (mb_strlen($condition_calculation_type) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_calculation_type when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionCurrency($condition_currency)
    {
        ...
        if (!is_null($condition_currency) && (mb_strlen($condition_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $condition_currency when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 5.');
        }
    ...
    public function setConditionQuantityUnit($condition_quantity_unit)
    {
        ...
        if (!is_null($condition_quantity_unit) && (mb_strlen($condition_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_quantity_unit when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionCategory($condition_category)
    {
        ...
        if (!is_null($condition_category) && (mb_strlen($condition_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_category when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setPricingScaleType($pricing_scale_type)
    {
        ...
        if (!is_null($pricing_scale_type) && (mb_strlen($pricing_scale_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $pricing_scale_type when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionOrigin($condition_origin)
    {
        ...
        if (!is_null($condition_origin) && (mb_strlen($condition_origin) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_origin when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setIsGroupCondition($is_group_condition)
    {
        ...
        if (!is_null($is_group_condition) && (mb_strlen($is_group_condition) > 1)) {
            throw new \InvalidArgumentException('invalid length for $is_group_condition when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionRecord($condition_record)
    {
        ...
        if (!is_null($condition_record) && (mb_strlen($condition_record) > 10)) {
            throw new \InvalidArgumentException('invalid length for $condition_record when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 10.');
        }
    ...
    public function setConditionSequentialNumber($condition_sequential_number)
    {
        ...
        if (!is_null($condition_sequential_number) && (mb_strlen($condition_sequential_number) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_sequential_number when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setTaxCode($tax_code)
    {
        ...
        if (!is_null($tax_code) && (mb_strlen($tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $tax_code when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 2.');
        }
    ...
    public function setWithholdingTaxCode($withholding_tax_code)
    {
        ...
        if (!is_null($withholding_tax_code) && (mb_strlen($withholding_tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_code when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 2.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 5.');
        }
    ...
    public function setConditionControl($condition_control)
    {
        ...
        if (!is_null($condition_control) && (mb_strlen($condition_control) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_control when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionInactiveReason($condition_inactive_reason)
    {
        ...
        if (!is_null($condition_inactive_reason) && (mb_strlen($condition_inactive_reason) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_inactive_reason when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionClass($condition_class)
    {
        ...
        if (!is_null($condition_class) && (mb_strlen($condition_class) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_class when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setPrcgProcedureCounterForHeader($prcg_procedure_counter_for_header)
    {
        ...
        if (!is_null($prcg_procedure_counter_for_header) && (mb_strlen($prcg_procedure_counter_for_header) > 3)) {
            throw new \InvalidArgumentException('invalid length for $prcg_procedure_counter_for_header when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setStructureCondition($structure_condition)
    {
        ...
        if (!is_null($structure_condition) && (mb_strlen($structure_condition) > 1)) {
            throw new \InvalidArgumentException('invalid length for $structure_condition when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setPricingScaleBasis($pricing_scale_basis)
    {
        ...
        if (!is_null($pricing_scale_basis) && (mb_strlen($pricing_scale_basis) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_scale_basis when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionScaleBasisUnit($condition_scale_basis_unit)
    {
        ...
        if (!is_null($condition_scale_basis_unit) && (mb_strlen($condition_scale_basis_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_scale_basis_unit when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionScaleBasisCurrency($condition_scale_basis_currency)
    {
        ...
        if (!is_null($condition_scale_basis_currency) && (mb_strlen($condition_scale_basis_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $condition_scale_basis_currency when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 5.');
        }
    ...
    public function setVariantCondition($variant_condition)
    {
        ...
        if (!is_null($variant_condition) && (mb_strlen($variant_condition) > 26)) {
            throw new \InvalidArgumentException('invalid length for $variant_condition when calling APICUSTOMERRETURNSRVACustomerReturnPrcgElmntType., must be smaller than or equal to 26.');
        }
