...
/**
 * FunctionResult1D Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class FunctionResult1D implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FunctionResult_1_d';
    ...
    protected static $openAPITypes = [
        'release_approval_request' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVFunctionResult'
    ];
    ...
    protected static array $openAPINullables = [
        'release_approval_request' => false
    ];
    ...
    protected static $setters = [
        'release_approval_request' => 'setReleaseApprovalRequest'
    ];
    ...
    protected static $getters = [
        'release_approval_request' => 'getReleaseApprovalRequest'
    ];
    ...
    {
        $this->setIfExists('release_approval_request', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets release_approval_request
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVFunctionResult|null
     */
    public function getReleaseApprovalRequest()
    {
        return $this->container['release_approval_request'];
    }

    /**
     * Sets release_approval_request
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVFunctionResult|null $release_approval_request release_approval_request
     *
     * @return self
     */
    public function setReleaseApprovalRequest($release_approval_request)
    {
        if (is_null($release_approval_request)) {
            throw new \InvalidArgumentException('non-nullable release_approval_request cannot be null');
        }
        $this->container['release_approval_request'] = $release_approval_request;
