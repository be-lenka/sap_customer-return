<?php
/**
 * APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnProcessStepType-create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rets_mgmt_process_item'] === null) {
            $invalidProperties[] = "'rets_mgmt_process_item' can't be null";
        }
        if ((mb_strlen($this->container['rets_mgmt_process_item']) > 6)) {
            $invalidProperties[] = "invalid value for 'rets_mgmt_process_item', the character length must be smaller than or equal to 6.";
        }

        if ($this->container['rets_mgmt_proc_itm_qty_split'] === null) {
            $invalidProperties[] = "'rets_mgmt_proc_itm_qty_split' can't be null";
        }
        if ((mb_strlen($this->container['rets_mgmt_proc_itm_qty_split']) > 3)) {
            $invalidProperties[] = "invalid value for 'rets_mgmt_proc_itm_qty_split', the character length must be smaller than or equal to 3.";
        }

        if ($this->container['rets_mgmt_process_step'] === null) {
            $invalidProperties[] = "'rets_mgmt_process_step' can't be null";
        }
        if ((mb_strlen($this->container['rets_mgmt_process_step']) > 4)) {
            $invalidProperties[] = "invalid value for 'rets_mgmt_process_step', the character length must be smaller than or equal to 4.";
        }

        if ($this->container['returns_document_type'] === null) {
            $invalidProperties[] = "'returns_document_type' can't be null";
        }
        if ((mb_strlen($this->container['returns_document_type']) > 2)) {
            $invalidProperties[] = "invalid value for 'returns_document_type', the character length must be smaller than or equal to 2.";
        }

        if ($this->container['returns_document'] === null) {
            $invalidProperties[] = "'returns_document' can't be null";
        }
        if ((mb_strlen($this->container['returns_document']) > 30)) {
            $invalidProperties[] = "invalid value for 'returns_document', the character length must be smaller than or equal to 30.";
        }

        if ($this->container['returns_document_item'] === null) {
            $invalidProperties[] = "'returns_document_item' can't be null";
        }
        if ((mb_strlen($this->container['returns_document_item']) > 10)) {
    ...
    public function setRetsMgmtProcess($rets_mgmt_process)
    {
        ...
        if ((mb_strlen($rets_mgmt_process) > 10)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_process when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string $rets_mgmt_process_item Item Number
     *
     * @return self
     */
    public function setRetsMgmtProcessItem($rets_mgmt_process_item)
    {
        ...
        if ((mb_strlen($rets_mgmt_process_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_process_item when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 6.');
        }
     ...
     *
     * @param string $rets_mgmt_proc_itm_qty_split Split Identification Number
     *
     * @return self
     */
    public function setRetsMgmtProcItmQtySplit($rets_mgmt_proc_itm_qty_split)
    {
        ...
        if ((mb_strlen($rets_mgmt_proc_itm_qty_split) > 3)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_proc_itm_qty_split when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 3.');
        }
     ...
     *
     * @param string $rets_mgmt_process_step rets_mgmt_process_step
     *
     * @return self
     */
    public function setRetsMgmtProcessStep($rets_mgmt_process_step)
    {
        ...
        if ((mb_strlen($rets_mgmt_process_step) > 4)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_process_step when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 4.');
        }
     ...
     *
     * @param string $returns_document_type returns_document_type
     *
     * @return self
     */
    public function setReturnsDocumentType($returns_document_type)
    {
        ...
        if ((mb_strlen($returns_document_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $returns_document_type when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 2.');
        }
     ...
     *
     * @param string $returns_document returns_document
     *
     * @return self
     */
    public function setReturnsDocument($returns_document)
    {
        ...
        if ((mb_strlen($returns_document) > 30)) {
            throw new \InvalidArgumentException('invalid length for $returns_document when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 30.');
        }
     ...
     *
     * @param string $returns_document_item returns_document_item
     *
     * @return self
     */
    public function setReturnsDocumentItem($returns_document_item)
    {
        ...
        if ((mb_strlen($returns_document_item) > 10)) {
            throw new \InvalidArgumentException('invalid length for $returns_document_item when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setReturnsDocumentStatus($returns_document_status)
    {
        ...
        if (!is_null($returns_document_status) && (mb_strlen($returns_document_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_document_status when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setReturnsDocumentApprovalStatus($returns_document_approval_status)
    {
        ...
        if (!is_null($returns_document_approval_status) && (mb_strlen($returns_document_approval_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_document_approval_status when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setReturnsReferenceDocumentType($returns_reference_document_type)
    {
        ...
        if (!is_null($returns_reference_document_type) && (mb_strlen($returns_reference_document_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $returns_reference_document_type when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setReturnsReferenceDocument($returns_reference_document)
    {
        ...
        if (!is_null($returns_reference_document) && (mb_strlen($returns_reference_document) > 30)) {
            throw new \InvalidArgumentException('invalid length for $returns_reference_document when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 30.');
        }
    ...
    public function setReturnsReferenceDocumentItem($returns_reference_document_item)
    {
        ...
        if (!is_null($returns_reference_document_item) && (mb_strlen($returns_reference_document_item) > 10)) {
            throw new \InvalidArgumentException('invalid length for $returns_reference_document_item when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setRetsMgmtProcStepExecStatus($rets_mgmt_proc_step_exec_status)
    {
        ...
        if (!is_null($rets_mgmt_proc_step_exec_status) && (mb_strlen($rets_mgmt_proc_step_exec_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_proc_step_exec_status when calling APICUSTOMERRETURNSRVACustomerReturnProcessStepTypeCreate., must be smaller than or equal to 1.');
        }
