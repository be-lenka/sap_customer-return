<?php
/**
 * APICUSTOMERRETURNSRVACustomerReturnItemPartnerType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APICUSTOMERRETURNSRVACustomerReturnItemPartnerType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnItemPartnerType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnItemPartnerType';
    ...
    */
    ...
    public function setCustomerReturn($customer_return)
    {
        ...
        if ((mb_strlen($customer_return) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_return when calling APICUSTOMERRETURNSRVACustomerReturnItemPartnerType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string|null $customer_return_item Item number of the SD document
     *
     * @return self
     */
    public function setCustomerReturnItem($customer_return_item)
    {
        ...
        if ((mb_strlen($customer_return_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_item when calling APICUSTOMERRETURNSRVACustomerReturnItemPartnerType., must be smaller than or equal to 6.');
        }
    ...
    public function setPartnerFunction($partner_function)
    {
        ...
        if ((mb_strlen($partner_function) > 2)) {
            throw new \InvalidArgumentException('invalid length for $partner_function when calling APICUSTOMERRETURNSRVACustomerReturnItemPartnerType., must be smaller than or equal to 2.');
        }
    ...
    public function setPartnerFunctionInternalCode($partner_function_internal_code)
    {
        ...
        if (!is_null($partner_function_internal_code) && (mb_strlen($partner_function_internal_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $partner_function_internal_code when calling APICUSTOMERRETURNSRVACustomerReturnItemPartnerType., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if (!is_null($customer) && (mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APICUSTOMERRETURNSRVACustomerReturnItemPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if (!is_null($supplier) && (mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APICUSTOMERRETURNSRVACustomerReturnItemPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setPersonnel($personnel)
    {
        ...
        if (!is_null($personnel) && (mb_strlen($personnel) > 8)) {
            throw new \InvalidArgumentException('invalid length for $personnel when calling APICUSTOMERRETURNSRVACustomerReturnItemPartnerType., must be smaller than or equal to 8.');
        }
    ...
    public function setContactPerson($contact_person)
    {
        ...
        if (!is_null($contact_person) && (mb_strlen($contact_person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $contact_person when calling APICUSTOMERRETURNSRVACustomerReturnItemPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceBusinessPartner($reference_business_partner)
    {
        ...
        if (!is_null($reference_business_partner) && (mb_strlen($reference_business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_business_partner when calling APICUSTOMERRETURNSRVACustomerReturnItemPartnerType., must be smaller than or equal to 10.');
        }
