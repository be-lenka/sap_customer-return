...
/**
 * APICUSTOMERRETURNSRVACustomerReturnTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnType-update';
    ...
    */
    ...
    public function setCustomerReturnType($customer_return_type)
    {
        ...
        if (!is_null($customer_return_type) && (mb_strlen($customer_return_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_type when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesOrganization($sales_organization)
    {
        ...
        if (!is_null($sales_organization) && (mb_strlen($sales_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_organization when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setDistributionChannel($distribution_channel)
    {
        ...
        if (!is_null($distribution_channel) && (mb_strlen($distribution_channel) > 2)) {
            throw new \InvalidArgumentException('invalid length for $distribution_channel when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setOrganizationDivision($organization_division)
    {
        ...
        if (!is_null($organization_division) && (mb_strlen($organization_division) > 2)) {
            throw new \InvalidArgumentException('invalid length for $organization_division when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setSalesGroup($sales_group)
    {
        ...
        if (!is_null($sales_group) && (mb_strlen($sales_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sales_group when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setSalesOffice($sales_office)
    {
        ...
        if (!is_null($sales_office) && (mb_strlen($sales_office) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_office when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesDistrict($sales_district)
    {
        ...
        if (!is_null($sales_district) && (mb_strlen($sales_district) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_district when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setSoldToParty($sold_to_party)
    {
        ...
        if (!is_null($sold_to_party) && (mb_strlen($sold_to_party) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sold_to_party when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPurchaseOrderByCustomer($purchase_order_by_customer)
    {
        ...
        if (!is_null($purchase_order_by_customer) && (mb_strlen($purchase_order_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_customer when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 35.');
        }
    ...
    public function setCustomerPurchaseOrderType($customer_purchase_order_type)
    {
        ...
        if (!is_null($customer_purchase_order_type) && (mb_strlen($customer_purchase_order_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_purchase_order_type when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 5.');
        }
    ...
    public function setSdDocumentReason($sd_document_reason)
    {
        ...
        if (!is_null($sd_document_reason) && (mb_strlen($sd_document_reason) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_reason when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setHeaderBillingBlockReason($header_billing_block_reason)
    {
        ...
        if (!is_null($header_billing_block_reason) && (mb_strlen($header_billing_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $header_billing_block_reason when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryBlockReason($delivery_block_reason)
    {
        ...
        if (!is_null($delivery_block_reason) && (mb_strlen($delivery_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_block_reason when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsVersion($incoterms_version)
    {
        ...
        if (!is_null($incoterms_version) && (mb_strlen($incoterms_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_version when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setCustomerPaymentTerms($customer_payment_terms)
    {
        ...
        if (!is_null($customer_payment_terms) && (mb_strlen($customer_payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_payment_terms when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentMethod($payment_method)
    {
        ...
        if (!is_null($payment_method) && (mb_strlen($payment_method) > 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_method when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification1($customer_tax_classification1)
    {
        ...
        if (!is_null($customer_tax_classification1) && (mb_strlen($customer_tax_classification1) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification1 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification2($customer_tax_classification2)
    {
        ...
        if (!is_null($customer_tax_classification2) && (mb_strlen($customer_tax_classification2) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification2 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification3($customer_tax_classification3)
    {
        ...
        if (!is_null($customer_tax_classification3) && (mb_strlen($customer_tax_classification3) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification3 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification4($customer_tax_classification4)
    {
        ...
        if (!is_null($customer_tax_classification4) && (mb_strlen($customer_tax_classification4) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification4 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification5($customer_tax_classification5)
    {
        ...
        if (!is_null($customer_tax_classification5) && (mb_strlen($customer_tax_classification5) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification5 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification6($customer_tax_classification6)
    {
        ...
        if (!is_null($customer_tax_classification6) && (mb_strlen($customer_tax_classification6) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification6 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification7($customer_tax_classification7)
    {
        ...
        if (!is_null($customer_tax_classification7) && (mb_strlen($customer_tax_classification7) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification7 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification8($customer_tax_classification8)
    {
        ...
        if (!is_null($customer_tax_classification8) && (mb_strlen($customer_tax_classification8) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification8 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification9($customer_tax_classification9)
    {
        ...
        if (!is_null($customer_tax_classification9) && (mb_strlen($customer_tax_classification9) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification9 when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setReferenceSdDocument($reference_sd_document)
    {
        ...
        if (!is_null($reference_sd_document) && (mb_strlen($reference_sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setAccountingDocExternalReference($accounting_doc_external_reference)
    {
        ...
        if (!is_null($accounting_doc_external_reference) && (mb_strlen($accounting_doc_external_reference) > 16)) {
            throw new \InvalidArgumentException('invalid length for $accounting_doc_external_reference when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 16.');
        }
    ...
    public function setAssignmentReference($assignment_reference)
    {
        ...
        if (!is_null($assignment_reference) && (mb_strlen($assignment_reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $assignment_reference when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 18.');
        }
    ...
    public function setCustomerReturnApprovalReason($customer_return_approval_reason)
    {
        ...
        if (!is_null($customer_return_approval_reason) && (mb_strlen($customer_return_approval_reason) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_approval_reason when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesDocApprovalStatus($sales_doc_approval_status)
    {
        ...
        if (!is_null($sales_doc_approval_status) && (mb_strlen($sales_doc_approval_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $sales_doc_approval_status when calling APICUSTOMERRETURNSRVACustomerReturnTypeUpdate., must be smaller than or equal to 1.');
        }
