<?php
/**
 * APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnItemType-create';
    ...
    protected static $openAPITypes = [
        ...
        'to_partner' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToPartner',
        'to_pricing_element' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToPricingElement',
        'to_process_step' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToProcessStep',
        'to_related_object' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToRelatedObject',
        'to_schedule_line' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToScheduleLine',
        'to_serial_number' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToSerialNumber',
        'to_text' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToText'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customer_return_item'] === null) {
            $invalidProperties[] = "'customer_return_item' can't be null";
        }
        if ((mb_strlen($this->container['customer_return_item']) > 6)) {
     ...
     *
     * @param string $customer_return_item customer_return_item
     *
     * @return self
     */
    public function setCustomerReturnItem($customer_return_item)
    {
        ...
        if ((mb_strlen($customer_return_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_item when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setHigherLevelItem($higher_level_item)
    {
        ...
        if (!is_null($higher_level_item) && (mb_strlen($higher_level_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $higher_level_item when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setCustomerReturnItemCategory($customer_return_item_category)
    {
        ...
        if (!is_null($customer_return_item_category) && (mb_strlen($customer_return_item_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_item_category when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setCustomerReturnItemText($customer_return_item_text)
    {
        ...
        if (!is_null($customer_return_item_text) && (mb_strlen($customer_return_item_text) > 40)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_item_text when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setPurchaseOrderByCustomer($purchase_order_by_customer)
    {
        ...
        if (!is_null($purchase_order_by_customer) && (mb_strlen($purchase_order_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_customer when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 35.');
        }
    ...
    public function setMaterial($material)
    {
        ...
        if (!is_null($material) && (mb_strlen($material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $material when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setMaterialByCustomer($material_by_customer)
    {
        ...
        if (!is_null($material_by_customer) && (mb_strlen($material_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $material_by_customer when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 35.');
        }
    ...
    public function setRequestedQuantityUnit($requested_quantity_unit)
    {
        ...
        if (!is_null($requested_quantity_unit) && (mb_strlen($requested_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $requested_quantity_unit when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setMaterialGroup($material_group)
    {
        ...
        if (!is_null($material_group) && (mb_strlen($material_group) > 9)) {
            throw new \InvalidArgumentException('invalid length for $material_group when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 9.');
        }
    ...
    public function setProductionPlant($production_plant)
    {
        ...
        if (!is_null($production_plant) && (mb_strlen($production_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $production_plant when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setStorageLocation($storage_location)
    {
        ...
        if (!is_null($storage_location) && (mb_strlen($storage_location) > 4)) {
            throw new \InvalidArgumentException('invalid length for $storage_location when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingPoint($shipping_point)
    {
        ...
        if (!is_null($shipping_point) && (mb_strlen($shipping_point) > 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_point when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryPriority($delivery_priority)
    {
        ...
        if (!is_null($delivery_priority) && (mb_strlen($delivery_priority) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_priority when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 70.');
        }
    ...
    public function setCustomerPaymentTerms($customer_payment_terms)
    {
        ...
        if (!is_null($customer_payment_terms) && (mb_strlen($customer_payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_payment_terms when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setProductTaxClassification1($product_tax_classification1)
    {
        ...
        if (!is_null($product_tax_classification1) && (mb_strlen($product_tax_classification1) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification1 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification2($product_tax_classification2)
    {
        ...
        if (!is_null($product_tax_classification2) && (mb_strlen($product_tax_classification2) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification2 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification3($product_tax_classification3)
    {
        ...
        if (!is_null($product_tax_classification3) && (mb_strlen($product_tax_classification3) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification3 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification4($product_tax_classification4)
    {
        ...
        if (!is_null($product_tax_classification4) && (mb_strlen($product_tax_classification4) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification4 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification5($product_tax_classification5)
    {
        ...
        if (!is_null($product_tax_classification5) && (mb_strlen($product_tax_classification5) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification5 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification6($product_tax_classification6)
    {
        ...
        if (!is_null($product_tax_classification6) && (mb_strlen($product_tax_classification6) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification6 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification7($product_tax_classification7)
    {
        ...
        if (!is_null($product_tax_classification7) && (mb_strlen($product_tax_classification7) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification7 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification8($product_tax_classification8)
    {
        ...
        if (!is_null($product_tax_classification8) && (mb_strlen($product_tax_classification8) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification8 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification9($product_tax_classification9)
    {
        ...
        if (!is_null($product_tax_classification9) && (mb_strlen($product_tax_classification9) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification9 when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setSalesDocumentRjcnReason($sales_document_rjcn_reason)
    {
        ...
        if (!is_null($sales_document_rjcn_reason) && (mb_strlen($sales_document_rjcn_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $sales_document_rjcn_reason when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setItemBillingBlockReason($item_billing_block_reason)
    {
        ...
        if (!is_null($item_billing_block_reason) && (mb_strlen($item_billing_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $item_billing_block_reason when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setProfitCenter($profit_center)
    {
        ...
        if (!is_null($profit_center) && (mb_strlen($profit_center) > 10)) {
            throw new \InvalidArgumentException('invalid length for $profit_center when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setReturnReason($return_reason)
    {
        ...
        if (!is_null($return_reason) && (mb_strlen($return_reason) > 3)) {
            throw new \InvalidArgumentException('invalid length for $return_reason when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setRetsMgmtProcessingBlock($rets_mgmt_processing_block)
    {
        ...
        if (!is_null($rets_mgmt_processing_block) && (mb_strlen($rets_mgmt_processing_block) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_processing_block when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustRetItmFollowUpActivity($cust_ret_itm_follow_up_activity)
    {
        ...
        if (!is_null($cust_ret_itm_follow_up_activity) && (mb_strlen($cust_ret_itm_follow_up_activity) > 4)) {
            throw new \InvalidArgumentException('invalid length for $cust_ret_itm_follow_up_activity when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setReturnsMaterialHasBeenReceived($returns_material_has_been_received)
    {
        ...
        if (!is_null($returns_material_has_been_received) && (mb_strlen($returns_material_has_been_received) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_material_has_been_received when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setReturnsRefundType($returns_refund_type)
    {
        ...
        if (!is_null($returns_refund_type) && (mb_strlen($returns_refund_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_refund_type when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setReturnsRefundProcgMode($returns_refund_procg_mode)
    {
        ...
        if (!is_null($returns_refund_procg_mode) && (mb_strlen($returns_refund_procg_mode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_refund_procg_mode when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setRetsProdValnIsSuspended($rets_prod_valn_is_suspended)
    {
        ...
        if (!is_null($rets_prod_valn_is_suspended) && (mb_strlen($rets_prod_valn_is_suspended) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_prod_valn_is_suspended when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setReturnsRefundExtent($returns_refund_extent)
    {
        ...
        if (!is_null($returns_refund_extent) && (mb_strlen($returns_refund_extent) > 3)) {
            throw new \InvalidArgumentException('invalid length for $returns_refund_extent when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setPrelimRefundIsDetermined($prelim_refund_is_determined)
    {
        ...
        if (!is_null($prelim_refund_is_determined) && (mb_strlen($prelim_refund_is_determined) > 1)) {
            throw new \InvalidArgumentException('invalid length for $prelim_refund_is_determined when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setReplacementMaterial($replacement_material)
    {
        ...
        if (!is_null($replacement_material) && (mb_strlen($replacement_material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $replacement_material when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setReplacementMaterialQtyUnit($replacement_material_qty_unit)
    {
        ...
        if (!is_null($replacement_material_qty_unit) && (mb_strlen($replacement_material_qty_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $replacement_material_qty_unit when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setReplacementMaterialIsRequested($replacement_material_is_requested)
    {
        ...
        if (!is_null($replacement_material_is_requested) && (mb_strlen($replacement_material_is_requested) > 1)) {
            throw new \InvalidArgumentException('invalid length for $replacement_material_is_requested when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setReplacementMatlSupplyingPlant($replacement_matl_supplying_plant)
    {
        ...
        if (!is_null($replacement_matl_supplying_plant) && (mb_strlen($replacement_matl_supplying_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $replacement_matl_supplying_plant when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setNextPlantForFollowUpActivity($next_plant_for_follow_up_activity)
    {
        ...
        if (!is_null($next_plant_for_follow_up_activity) && (mb_strlen($next_plant_for_follow_up_activity) > 4)) {
            throw new \InvalidArgumentException('invalid length for $next_plant_for_follow_up_activity when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setReturnsTransshipmentPlant($returns_transshipment_plant)
    {
        ...
        if (!is_null($returns_transshipment_plant) && (mb_strlen($returns_transshipment_plant) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_transshipment_plant when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if (!is_null($supplier) && (mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplierRetMatlAuthzn($supplier_ret_matl_authzn)
    {
        ...
        if (!is_null($supplier_ret_matl_authzn) && (mb_strlen($supplier_ret_matl_authzn) > 20)) {
            throw new \InvalidArgumentException('invalid length for $supplier_ret_matl_authzn when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 20.');
        }
    ...
    public function setCustomerRetMatlInspResultCode($customer_ret_matl_insp_result_code)
    {
        ...
        if (!is_null($customer_ret_matl_insp_result_code) && (mb_strlen($customer_ret_matl_insp_result_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_ret_matl_insp_result_code when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setNextFllwUpActivityForMatlInsp($next_fllw_up_activity_for_matl_insp)
    {
        ...
        if (!is_null($next_fllw_up_activity_for_matl_insp) && (mb_strlen($next_fllw_up_activity_for_matl_insp) > 4)) {
            throw new \InvalidArgumentException('invalid length for $next_fllw_up_activity_for_matl_insp when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setRetMatlInspResultCode($ret_matl_insp_result_code)
    {
        ...
        if (!is_null($ret_matl_insp_result_code) && (mb_strlen($ret_matl_insp_result_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $ret_matl_insp_result_code when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setProductIsInspectedAtCustSite($product_is_inspected_at_cust_site)
    {
        ...
        if (!is_null($product_is_inspected_at_cust_site) && (mb_strlen($product_is_inspected_at_cust_site) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_is_inspected_at_cust_site when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setReferenceSdDocument($reference_sd_document)
    {
        ...
        if (!is_null($reference_sd_document) && (mb_strlen($reference_sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceSdDocumentItem($reference_sd_document_item)
    {
        ...
        if (!is_null($reference_sd_document_item) && (mb_strlen($reference_sd_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document_item when calling APICUSTOMERRETURNSRVACustomerReturnItemTypeCreate., must be smaller than or equal to 6.');
        }
     ...
     * Gets to_partner
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToPartner|null
     */
     ...
     * Sets to_partner
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToPartner|null $to_partner to_partner
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToPricingElement|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToPricingElement|null $to_pricing_element to_pricing_element
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToProcessStep|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToProcessStep|null $to_process_step to_process_step
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToRelatedObject|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToRelatedObject|null $to_related_object to_related_object
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToScheduleLine|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToScheduleLine|null $to_schedule_line to_schedule_line
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToSerialNumber|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToSerialNumber|null $to_serial_number to_serial_number
     *
     * @return self
     */
     ...
     * Gets to_text
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToText|null
     */
     ...
     * Sets to_text
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeCreateToText|null $to_text to_text
     *
     * @return self
     */
