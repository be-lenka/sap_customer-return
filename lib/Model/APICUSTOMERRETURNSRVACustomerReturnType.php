...
/**
 * APICUSTOMERRETURNSRVACustomerReturnType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnType';
    ...
    protected static $openAPITypes = [
        ...
        'customer_return_approval_reason' => 'string',
        ...
        'to_customer_return_overview_status' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnOverviewStatusType',
        'to_item' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToItem',
        'to_partner' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToPartner',
        'to_pricing_element' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToPricingElement',
        'to_related_object' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToRelatedObject',
        'to_text' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToText'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'customer_return_approval_reason' => null,
        ...
        'to_customer_return_overview_status' => null,
        'to_item' => null,
        'to_partner' => null,
    ...
    protected static array $openAPINullables = [
		...
		'customer_return_approval_reason' => true,
		...
		'to_customer_return_overview_status' => true,
		'to_item' => false,
		'to_partner' => false,
    ...
    protected static $attributeMap = [
        ...
        'customer_return_type' => 'CustomerReturnType',
        ...
        'customer_return_date' => 'CustomerReturnDate',
        ...
        'customer_return_approval_reason' => 'CustomerReturnApprovalReason',
        ...
        'to_customer_return_overview_status' => 'to_CustomerReturnOverviewStatus',
        'to_item' => 'to_Item',
    ...
    protected static $setters = [
        ...
        'customer_return_type' => 'setCustomerReturnType',
        ...
        'customer_return_date' => 'setCustomerReturnDate',
        ...
        'customer_return_approval_reason' => 'setCustomerReturnApprovalReason',
        ...
        'to_customer_return_overview_status' => 'setToCustomerReturnOverviewStatus',
        'to_item' => 'setToItem',
    ...
    protected static $getters = [
        ...
        'customer_return_type' => 'getCustomerReturnType',
        ...
        'customer_return_date' => 'getCustomerReturnDate',
        ...
        'customer_return_approval_reason' => 'getCustomerReturnApprovalReason',
        ...
        'to_customer_return_overview_status' => 'getToCustomerReturnOverviewStatus',
        'to_item' => 'getToItem',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('customer_return_type', $data ?? [], null);
        ...
        $this->setIfExists('customer_return_date', $data ?? [], null);
        ...
        $this->setIfExists('customer_return_approval_reason', $data ?? [], null);
        ...
        $this->setIfExists('to_customer_return_overview_status', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['customer_return_type']) && (mb_strlen($this->container['customer_return_type']) > 4)) {
            $invalidProperties[] = "invalid value for 'customer_return_type', the character length must be smaller than or equal to 4.";
        }
        ...
        if (!is_null($this->container['customer_return_approval_reason']) && (mb_strlen($this->container['customer_return_approval_reason']) > 4)) {
            $invalidProperties[] = "invalid value for 'customer_return_approval_reason', the character length must be smaller than or equal to 4.";
        }
    ...
    public function setCustomerReturn($customer_return)
    {
        ...
        if ((mb_strlen($customer_return) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_return when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 10.');
        }
    ...
    /**
     * Gets customer_return_type
     *
     * @return string|null
     */
    public function getCustomerReturnType()
    {
        return $this->container['customer_return_type'];
    }

    /**
     * Sets customer_return_type
     *
     * @param string|null $customer_return_type customer_return_type
     *
     * @return self
     */
    public function setCustomerReturnType($customer_return_type)
    {
        if (is_null($customer_return_type)) {
            array_push($this->openAPINullablesSetToNull, 'customer_return_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_return_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($customer_return_type) && (mb_strlen($customer_return_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_type when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 4.');
        }

        $this->container['customer_return_type'] = $customer_return_type;
    ...
    public function setSalesOrganization($sales_organization)
    {
        ...
        if (!is_null($sales_organization) && (mb_strlen($sales_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_organization when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 4.');
        }
    ...
    public function setDistributionChannel($distribution_channel)
    {
        ...
        if (!is_null($distribution_channel) && (mb_strlen($distribution_channel) > 2)) {
            throw new \InvalidArgumentException('invalid length for $distribution_channel when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 2.');
        }
    ...
    public function setOrganizationDivision($organization_division)
    {
        ...
        if (!is_null($organization_division) && (mb_strlen($organization_division) > 2)) {
            throw new \InvalidArgumentException('invalid length for $organization_division when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 2.');
        }
    ...
    public function setSalesGroup($sales_group)
    {
        ...
        if (!is_null($sales_group) && (mb_strlen($sales_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sales_group when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 3.');
        }
    ...
    public function setSalesOffice($sales_office)
    {
        ...
        if (!is_null($sales_office) && (mb_strlen($sales_office) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_office when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesDistrict($sales_district)
    {
        ...
        if (!is_null($sales_district) && (mb_strlen($sales_district) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_district when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 6.');
        }
    ...
    public function setSoldToParty($sold_to_party)
    {
        ...
        if (!is_null($sold_to_party) && (mb_strlen($sold_to_party) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sold_to_party when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 10.');
        }
    ...
    public function setCreatedByUser($created_by_user)
    {
        ...
        if (!is_null($created_by_user) && (mb_strlen($created_by_user) > 12)) {
            throw new \InvalidArgumentException('invalid length for $created_by_user when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 12.');
        }
    ...
    public function setSenderBusinessSystemName($sender_business_system_name)
    {
        ...
        if (!is_null($sender_business_system_name) && (mb_strlen($sender_business_system_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $sender_business_system_name when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 60.');
        }
    ...
    public function setPurchaseOrderByCustomer($purchase_order_by_customer)
    {
        ...
        if (!is_null($purchase_order_by_customer) && (mb_strlen($purchase_order_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_customer when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 35.');
        }
    ...
    public function setCustomerPurchaseOrderType($customer_purchase_order_type)
    {
        ...
        if (!is_null($customer_purchase_order_type) && (mb_strlen($customer_purchase_order_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_purchase_order_type when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 4.');
        }
    ...
    /**
     * Gets customer_return_date
     *
     * @return string|null
     */
    public function getCustomerReturnDate()
    {
        return $this->container['customer_return_date'];
    }

    /**
     * Sets customer_return_date
     *
     * @param string|null $customer_return_date Document Date (Date Received/Sent)
     *
     * @return self
     */
    public function setCustomerReturnDate($customer_return_date)
    {
        if (is_null($customer_return_date)) {
            array_push($this->openAPINullablesSetToNull, 'customer_return_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_return_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['customer_return_date'] = $customer_return_date;
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 5.');
        }
    ...
    public function setSdDocumentReason($sd_document_reason)
    {
        ...
        if (!is_null($sd_document_reason) && (mb_strlen($sd_document_reason) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_reason when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 3.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 2.');
        }
    ...
    public function setHeaderBillingBlockReason($header_billing_block_reason)
    {
        ...
        if (!is_null($header_billing_block_reason) && (mb_strlen($header_billing_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $header_billing_block_reason when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryBlockReason($delivery_block_reason)
    {
        ...
        if (!is_null($delivery_block_reason) && (mb_strlen($delivery_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_block_reason when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 2.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsVersion($incoterms_version)
    {
        ...
        if (!is_null($incoterms_version) && (mb_strlen($incoterms_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_version when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 4.');
        }
    ...
    public function setCustomerPaymentTerms($customer_payment_terms)
    {
        ...
        if (!is_null($customer_payment_terms) && (mb_strlen($customer_payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_payment_terms when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentMethod($payment_method)
    {
        ...
        if (!is_null($payment_method) && (mb_strlen($payment_method) > 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_method when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification1($customer_tax_classification1)
    {
        ...
        if (!is_null($customer_tax_classification1) && (mb_strlen($customer_tax_classification1) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification1 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification2($customer_tax_classification2)
    {
        ...
        if (!is_null($customer_tax_classification2) && (mb_strlen($customer_tax_classification2) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification2 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification3($customer_tax_classification3)
    {
        ...
        if (!is_null($customer_tax_classification3) && (mb_strlen($customer_tax_classification3) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification3 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification4($customer_tax_classification4)
    {
        ...
        if (!is_null($customer_tax_classification4) && (mb_strlen($customer_tax_classification4) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification4 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification5($customer_tax_classification5)
    {
        ...
        if (!is_null($customer_tax_classification5) && (mb_strlen($customer_tax_classification5) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification5 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification6($customer_tax_classification6)
    {
        ...
        if (!is_null($customer_tax_classification6) && (mb_strlen($customer_tax_classification6) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification6 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification7($customer_tax_classification7)
    {
        ...
        if (!is_null($customer_tax_classification7) && (mb_strlen($customer_tax_classification7) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification7 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification8($customer_tax_classification8)
    {
        ...
        if (!is_null($customer_tax_classification8) && (mb_strlen($customer_tax_classification8) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification8 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification9($customer_tax_classification9)
    {
        ...
        if (!is_null($customer_tax_classification9) && (mb_strlen($customer_tax_classification9) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification9 when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setRetsMgmtProcess($rets_mgmt_process)
    {
        ...
        if (!is_null($rets_mgmt_process) && (mb_strlen($rets_mgmt_process) > 10)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_process when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceSdDocument($reference_sd_document)
    {
        ...
        if (!is_null($reference_sd_document) && (mb_strlen($reference_sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceSdDocumentCategory($reference_sd_document_category)
    {
        ...
        if (!is_null($reference_sd_document_category) && (mb_strlen($reference_sd_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document_category when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 4.');
        }
    ...
    public function setAccountingDocExternalReference($accounting_doc_external_reference)
    {
        ...
        if (!is_null($accounting_doc_external_reference) && (mb_strlen($accounting_doc_external_reference) > 16)) {
            throw new \InvalidArgumentException('invalid length for $accounting_doc_external_reference when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 16.');
        }
    ...
    public function setAssignmentReference($assignment_reference)
    {
        ...
        if (!is_null($assignment_reference) && (mb_strlen($assignment_reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $assignment_reference when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 18.');
        }
    ...
    /**
     * Gets customer_return_approval_reason
     *
     * @return string|null
     */
    public function getCustomerReturnApprovalReason()
    {
        return $this->container['customer_return_approval_reason'];
    }

    /**
     * Sets customer_return_approval_reason
     *
     * @param string|null $customer_return_approval_reason Approval Request Reason ID
     *
     * @return self
     */
    public function setCustomerReturnApprovalReason($customer_return_approval_reason)
    {
        if (is_null($customer_return_approval_reason)) {
            array_push($this->openAPINullablesSetToNull, 'customer_return_approval_reason');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_return_approval_reason', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($customer_return_approval_reason) && (mb_strlen($customer_return_approval_reason) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_approval_reason when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 4.');
        }

        $this->container['customer_return_approval_reason'] = $customer_return_approval_reason;
    ...
    public function setSalesDocApprovalStatus($sales_doc_approval_status)
    {
        ...
        if (!is_null($sales_doc_approval_status) && (mb_strlen($sales_doc_approval_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $sales_doc_approval_status when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setRetsMgmtLogProcgStatus($rets_mgmt_log_procg_status)
    {
        ...
        if (!is_null($rets_mgmt_log_procg_status) && (mb_strlen($rets_mgmt_log_procg_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_log_procg_status when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setRetsMgmtCompnProcgStatus($rets_mgmt_compn_procg_status)
    {
        ...
        if (!is_null($rets_mgmt_compn_procg_status) && (mb_strlen($rets_mgmt_compn_procg_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_compn_procg_status when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setRetsMgmtProcessingStatus($rets_mgmt_processing_status)
    {
        ...
        if (!is_null($rets_mgmt_processing_status) && (mb_strlen($rets_mgmt_processing_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_processing_status when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallSdProcessStatus($overall_sd_process_status)
    {
        ...
        if (!is_null($overall_sd_process_status) && (mb_strlen($overall_sd_process_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_sd_process_status when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setTotalCreditCheckStatus($total_credit_check_status)
    {
        ...
        if (!is_null($total_credit_check_status) && (mb_strlen($total_credit_check_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $total_credit_check_status when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallSdDocumentRejectionSts($overall_sd_document_rejection_sts)
    {
        ...
        if (!is_null($overall_sd_document_rejection_sts) && (mb_strlen($overall_sd_document_rejection_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_sd_document_rejection_sts when calling APICUSTOMERRETURNSRVACustomerReturnType., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Gets to_customer_return_overview_status
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnOverviewStatusType|null
     */
    public function getToCustomerReturnOverviewStatus()
    {
        return $this->container['to_customer_return_overview_status'];
    }

    /**
     * Sets to_customer_return_overview_status
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnOverviewStatusType|null $to_customer_return_overview_status to_customer_return_overview_status
     *
     * @return self
     */
    public function setToCustomerReturnOverviewStatus($to_customer_return_overview_status)
    {
        if (is_null($to_customer_return_overview_status)) {
            array_push($this->openAPINullablesSetToNull, 'to_customer_return_overview_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('to_customer_return_overview_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['to_customer_return_overview_status'] = $to_customer_return_overview_status;
     ...
     * Gets to_item
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToItem|null
     */
     ...
     * Sets to_item
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToItem|null $to_item to_item
     *
     * @return self
     */
     ...
     * Gets to_partner
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToPartner|null
     */
     ...
     * Sets to_partner
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToPartner|null $to_partner to_partner
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToPricingElement|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToPricingElement|null $to_pricing_element to_pricing_element
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToRelatedObject|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToRelatedObject|null $to_related_object to_related_object
     *
     * @return self
     */
     ...
     * Gets to_text
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToText|null
     */
     ...
     * Sets to_text
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnTypeToText|null $to_text to_text
     *
     * @return self
     */
