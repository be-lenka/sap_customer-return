...
/**
 * APICUSTOMERRETURNSRVACustomerReturnSerialNumberTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnSerialNumberTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnSerialNumberType-create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['serial_number']) > 18)) {
    ...
    public function setSerialNumber($serial_number)
    {
        ...
        if ((mb_strlen($serial_number) > 18)) {
            throw new \InvalidArgumentException('invalid length for $serial_number when calling APICUSTOMERRETURNSRVACustomerReturnSerialNumberTypeCreate., must be smaller than or equal to 18.');
        }
