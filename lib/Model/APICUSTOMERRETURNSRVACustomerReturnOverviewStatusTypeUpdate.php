<?php
/**
 * APICUSTOMERRETURNSRVACustomerReturnOverviewStatusTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APICUSTOMERRETURNSRVACustomerReturnOverviewStatusTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnOverviewStatusTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnOverviewStatusType-update';
    ...
    */
    ...
    public function setReturnsDocument($returns_document)
    {
        ...
        if (!is_null($returns_document) && (mb_strlen($returns_document) > 30)) {
            throw new \InvalidArgumentException('invalid length for $returns_document when calling APICUSTOMERRETURNSRVACustomerReturnOverviewStatusTypeUpdate., must be smaller than or equal to 30.');
        }
    ...
    public function setRetsMgmtLogProcgStatus($rets_mgmt_log_procg_status)
    {
        ...
        if (!is_null($rets_mgmt_log_procg_status) && (mb_strlen($rets_mgmt_log_procg_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_log_procg_status when calling APICUSTOMERRETURNSRVACustomerReturnOverviewStatusTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setRetsMgmtCompnProcgStatus($rets_mgmt_compn_procg_status)
    {
        ...
        if (!is_null($rets_mgmt_compn_procg_status) && (mb_strlen($rets_mgmt_compn_procg_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_compn_procg_status when calling APICUSTOMERRETURNSRVACustomerReturnOverviewStatusTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setRetsMgmtProcessingStatus($rets_mgmt_processing_status)
    {
        ...
        if (!is_null($rets_mgmt_processing_status) && (mb_strlen($rets_mgmt_processing_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_processing_status when calling APICUSTOMERRETURNSRVACustomerReturnOverviewStatusTypeUpdate., must be smaller than or equal to 1.');
        }
