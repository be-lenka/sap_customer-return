...
/**
 * APICUSTOMERRETURNSRVACustomerReturnItemType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnItemType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnItemType';
    ...
    protected static $openAPITypes = [
        ...
        'returns_refund_rjcn_reason' => 'string',
        ...
        'suplr_ret_matl_authzn_is_required' => 'string',
        ...
        'cust_ret_matl_authzn' => 'string',
        'crm_logical_system' => 'string',
        'crm_object_uuid' => 'string',
        'crm_object_id' => 'string',
        'crm_object_type' => 'string',
        'rets_mgmt_itm_log_procg_status' => 'string',
        'rets_mgmt_itm_compn_procg_status' => 'string',
        'rets_mgmt_itm_procg_status' => 'string',
        ...
        'sd_document_rejection_status' => 'string',
        'to_customer_return' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnType',
        'to_partner' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToPartner',
        'to_pricing_element' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToPricingElement',
        'to_process_step' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToProcessStep',
        'to_related_object' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToRelatedObject',
        'to_schedule_line' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToScheduleLine',
        'to_serial_number' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToSerialNumber',
        'to_text' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToText'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'returns_refund_rjcn_reason' => null,
        ...
        'suplr_ret_matl_authzn_is_required' => null,
        ...
        'cust_ret_matl_authzn' => null,
        'crm_logical_system' => null,
        'crm_object_uuid' => null,
        'crm_object_id' => null,
        'crm_object_type' => null,
        'rets_mgmt_itm_log_procg_status' => null,
        'rets_mgmt_itm_compn_procg_status' => null,
        'rets_mgmt_itm_procg_status' => null,
        ...
        'sd_document_rejection_status' => null,
        'to_customer_return' => null,
        'to_partner' => null,
        'to_pricing_element' => null,
        'to_process_step' => null,
    ...
    protected static array $openAPINullables = [
		...
		'profit_center' => true,
		'rets_mgmt_process' => true,
		'rets_mgmt_process_item' => true,
		'return_reason' => true,
		...
		'returns_refund_rjcn_reason' => true,
		...
		'suplr_ret_matl_authzn_is_required' => true,
		...
		'cust_ret_matl_authzn' => true,
		'crm_logical_system' => true,
		'crm_object_uuid' => true,
		'crm_object_id' => true,
		'crm_object_type' => true,
		'rets_mgmt_itm_log_procg_status' => true,
		'rets_mgmt_itm_compn_procg_status' => true,
		'rets_mgmt_itm_procg_status' => true,
    ...
    protected static $attributeMap = [
        ...
        'returns_refund_rjcn_reason' => 'ReturnsRefundRjcnReason',
        ...
        'suplr_ret_matl_authzn_is_required' => 'SuplrRetMatlAuthznIsRequired',
        ...
        'cust_ret_matl_authzn' => 'CustRetMatlAuthzn',
        'crm_logical_system' => 'CRMLogicalSystem',
        'crm_object_uuid' => 'CRMObjectUUID',
        'crm_object_id' => 'CRMObjectID',
        'crm_object_type' => 'CRMObjectType',
        'rets_mgmt_itm_log_procg_status' => 'RetsMgmtItmLogProcgStatus',
        'rets_mgmt_itm_compn_procg_status' => 'RetsMgmtItmCompnProcgStatus',
        'rets_mgmt_itm_procg_status' => 'RetsMgmtItmProcgStatus',
    ...
    protected static $setters = [
        ...
        'customer_return_item' => 'setCustomerReturnItem',
        ...
        'returns_refund_rjcn_reason' => 'setReturnsRefundRjcnReason',
        ...
        'suplr_ret_matl_authzn_is_required' => 'setSuplrRetMatlAuthznIsRequired',
        ...
        'cust_ret_matl_authzn' => 'setCustRetMatlAuthzn',
        'crm_logical_system' => 'setCrmLogicalSystem',
        'crm_object_uuid' => 'setCrmObjectUuid',
        'crm_object_id' => 'setCrmObjectId',
        'crm_object_type' => 'setCrmObjectType',
        'rets_mgmt_itm_log_procg_status' => 'setRetsMgmtItmLogProcgStatus',
        'rets_mgmt_itm_compn_procg_status' => 'setRetsMgmtItmCompnProcgStatus',
        'rets_mgmt_itm_procg_status' => 'setRetsMgmtItmProcgStatus',
    ...
    protected static $getters = [
        ...
        'customer_return_item' => 'getCustomerReturnItem',
        ...
        'returns_refund_rjcn_reason' => 'getReturnsRefundRjcnReason',
        ...
        'suplr_ret_matl_authzn_is_required' => 'getSuplrRetMatlAuthznIsRequired',
        ...
        'cust_ret_matl_authzn' => 'getCustRetMatlAuthzn',
        'crm_logical_system' => 'getCrmLogicalSystem',
        'crm_object_uuid' => 'getCrmObjectUuid',
        'crm_object_id' => 'getCrmObjectId',
        'crm_object_type' => 'getCrmObjectType',
        'rets_mgmt_itm_log_procg_status' => 'getRetsMgmtItmLogProcgStatus',
        'rets_mgmt_itm_compn_procg_status' => 'getRetsMgmtItmCompnProcgStatus',
        'rets_mgmt_itm_procg_status' => 'getRetsMgmtItmProcgStatus',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('customer_return_item', $data ?? [], null);
        ...
        $this->setIfExists('returns_refund_rjcn_reason', $data ?? [], null);
        ...
        $this->setIfExists('suplr_ret_matl_authzn_is_required', $data ?? [], null);
        ...
        $this->setIfExists('cust_ret_matl_authzn', $data ?? [], null);
        $this->setIfExists('crm_logical_system', $data ?? [], null);
        $this->setIfExists('crm_object_uuid', $data ?? [], null);
        $this->setIfExists('crm_object_id', $data ?? [], null);
        $this->setIfExists('crm_object_type', $data ?? [], null);
        $this->setIfExists('rets_mgmt_itm_log_procg_status', $data ?? [], null);
        $this->setIfExists('rets_mgmt_itm_compn_procg_status', $data ?? [], null);
        $this->setIfExists('rets_mgmt_itm_procg_status', $data ?? [], null);
        ...
        $this->setIfExists('sd_document_rejection_status', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['customer_return_item']) && (mb_strlen($this->container['customer_return_item']) > 6)) {
            $invalidProperties[] = "invalid value for 'customer_return_item', the character length must be smaller than or equal to 6.";
        }
        ...
        if (!is_null($this->container['returns_refund_rjcn_reason']) && (mb_strlen($this->container['returns_refund_rjcn_reason']) > 2)) {
            $invalidProperties[] = "invalid value for 'returns_refund_rjcn_reason', the character length must be smaller than or equal to 2.";
        }
        ...
        if (!is_null($this->container['suplr_ret_matl_authzn_is_required']) && (mb_strlen($this->container['suplr_ret_matl_authzn_is_required']) > 1)) {
            $invalidProperties[] = "invalid value for 'suplr_ret_matl_authzn_is_required', the character length must be smaller than or equal to 1.";
        }
        ...
        if (!is_null($this->container['cust_ret_matl_authzn']) && (mb_strlen($this->container['cust_ret_matl_authzn']) > 20)) {
            $invalidProperties[] = "invalid value for 'cust_ret_matl_authzn', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['crm_logical_system']) && (mb_strlen($this->container['crm_logical_system']) > 10)) {
            $invalidProperties[] = "invalid value for 'crm_logical_system', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['crm_object_uuid']) && (mb_strlen($this->container['crm_object_uuid']) > 32)) {
            $invalidProperties[] = "invalid value for 'crm_object_uuid', the character length must be smaller than or equal to 32.";
        }

        if (!is_null($this->container['crm_object_id']) && (mb_strlen($this->container['crm_object_id']) > 10)) {
            $invalidProperties[] = "invalid value for 'crm_object_id', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['crm_object_type']) && (mb_strlen($this->container['crm_object_type']) > 10)) {
            $invalidProperties[] = "invalid value for 'crm_object_type', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['rets_mgmt_itm_log_procg_status']) && (mb_strlen($this->container['rets_mgmt_itm_log_procg_status']) > 1)) {
            $invalidProperties[] = "invalid value for 'rets_mgmt_itm_log_procg_status', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['rets_mgmt_itm_compn_procg_status']) && (mb_strlen($this->container['rets_mgmt_itm_compn_procg_status']) > 1)) {
            $invalidProperties[] = "invalid value for 'rets_mgmt_itm_compn_procg_status', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['rets_mgmt_itm_procg_status']) && (mb_strlen($this->container['rets_mgmt_itm_procg_status']) > 1)) {
            $invalidProperties[] = "invalid value for 'rets_mgmt_itm_procg_status', the character length must be smaller than or equal to 1.";
        }
        ...
        if (!is_null($this->container['sd_document_rejection_status']) && (mb_strlen($this->container['sd_document_rejection_status']) > 1)) {
            $invalidProperties[] = "invalid value for 'sd_document_rejection_status', the character length must be smaller than or equal to 1.";
        }
    ...
    public function setCustomerReturn($customer_return)
    {
        ...
        if ((mb_strlen($customer_return) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_return when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 10.');
        }
    ...
    /**
     * Gets customer_return_item
     *
     * @return string|null
     */
    public function getCustomerReturnItem()
    {
        return $this->container['customer_return_item'];
    }

    /**
     * Sets customer_return_item
     *
     * @param string|null $customer_return_item customer_return_item
     *
     * @return self
     */
    public function setCustomerReturnItem($customer_return_item)
    {
        if (is_null($customer_return_item)) {
            throw new \InvalidArgumentException('non-nullable customer_return_item cannot be null');
        }
        if ((mb_strlen($customer_return_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_item when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 6.');
        }

        $this->container['customer_return_item'] = $customer_return_item;
    ...
    public function setHigherLevelItem($higher_level_item)
    {
        ...
        if (!is_null($higher_level_item) && (mb_strlen($higher_level_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $higher_level_item when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 6.');
        }
    ...
    public function setCustomerReturnItemCategory($customer_return_item_category)
    {
        ...
        if (!is_null($customer_return_item_category) && (mb_strlen($customer_return_item_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_item_category when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setCustomerReturnItemText($customer_return_item_text)
    {
        ...
        if (!is_null($customer_return_item_text) && (mb_strlen($customer_return_item_text) > 40)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_item_text when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 40.');
        }
    ...
    public function setPurchaseOrderByCustomer($purchase_order_by_customer)
    {
        ...
        if (!is_null($purchase_order_by_customer) && (mb_strlen($purchase_order_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_customer when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 35.');
        }
    ...
    public function setMaterial($material)
    {
        ...
        if (!is_null($material) && (mb_strlen($material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $material when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 40.');
        }
    ...
    public function setMaterialByCustomer($material_by_customer)
    {
        ...
        if (!is_null($material_by_customer) && (mb_strlen($material_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $material_by_customer when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 35.');
        }
    ...
    public function setRequestedQuantityUnit($requested_quantity_unit)
    {
        ...
        if (!is_null($requested_quantity_unit) && (mb_strlen($requested_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $requested_quantity_unit when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setItemWeightUnit($item_weight_unit)
    {
        ...
        if (!is_null($item_weight_unit) && (mb_strlen($item_weight_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_weight_unit when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setItemVolumeUnit($item_volume_unit)
    {
        ...
        if (!is_null($item_volume_unit) && (mb_strlen($item_volume_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_volume_unit when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 5.');
        }
    ...
    public function setMaterialGroup($material_group)
    {
        ...
        if (!is_null($material_group) && (mb_strlen($material_group) > 9)) {
            throw new \InvalidArgumentException('invalid length for $material_group when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 9.');
        }
    ...
    public function setBatch($batch)
    {
        ...
        if (!is_null($batch) && (mb_strlen($batch) > 10)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setProductionPlant($production_plant)
    {
        ...
        if (!is_null($production_plant) && (mb_strlen($production_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $production_plant when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setStorageLocation($storage_location)
    {
        ...
        if (!is_null($storage_location) && (mb_strlen($storage_location) > 4)) {
            throw new \InvalidArgumentException('invalid length for $storage_location when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingPoint($shipping_point)
    {
        ...
        if (!is_null($shipping_point) && (mb_strlen($shipping_point) > 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_point when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryPriority($delivery_priority)
    {
        ...
        if (!is_null($delivery_priority) && (mb_strlen($delivery_priority) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_priority when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 70.');
        }
    ...
    public function setCustomerPaymentTerms($customer_payment_terms)
    {
        ...
        if (!is_null($customer_payment_terms) && (mb_strlen($customer_payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_payment_terms when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setProductTaxClassification1($product_tax_classification1)
    {
        ...
        if (!is_null($product_tax_classification1) && (mb_strlen($product_tax_classification1) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification1 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification2($product_tax_classification2)
    {
        ...
        if (!is_null($product_tax_classification2) && (mb_strlen($product_tax_classification2) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification2 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification3($product_tax_classification3)
    {
        ...
        if (!is_null($product_tax_classification3) && (mb_strlen($product_tax_classification3) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification3 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification4($product_tax_classification4)
    {
        ...
        if (!is_null($product_tax_classification4) && (mb_strlen($product_tax_classification4) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification4 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification5($product_tax_classification5)
    {
        ...
        if (!is_null($product_tax_classification5) && (mb_strlen($product_tax_classification5) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification5 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification6($product_tax_classification6)
    {
        ...
        if (!is_null($product_tax_classification6) && (mb_strlen($product_tax_classification6) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification6 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification7($product_tax_classification7)
    {
        ...
        if (!is_null($product_tax_classification7) && (mb_strlen($product_tax_classification7) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification7 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification8($product_tax_classification8)
    {
        ...
        if (!is_null($product_tax_classification8) && (mb_strlen($product_tax_classification8) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification8 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification9($product_tax_classification9)
    {
        ...
        if (!is_null($product_tax_classification9) && (mb_strlen($product_tax_classification9) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification9 when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setSalesDocumentRjcnReason($sales_document_rjcn_reason)
    {
        ...
        if (!is_null($sales_document_rjcn_reason) && (mb_strlen($sales_document_rjcn_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $sales_document_rjcn_reason when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setItemBillingBlockReason($item_billing_block_reason)
    {
        ...
        if (!is_null($item_billing_block_reason) && (mb_strlen($item_billing_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $item_billing_block_reason when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setProfitCenter($profit_center)
    {
        ...
        if (!is_null($profit_center) && (mb_strlen($profit_center) > 10)) {
            throw new \InvalidArgumentException('invalid length for $profit_center when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setRetsMgmtProcess($rets_mgmt_process)
    {
        if (is_null($rets_mgmt_process)) {
            array_push($this->openAPINullablesSetToNull, 'rets_mgmt_process');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rets_mgmt_process', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($rets_mgmt_process) && (mb_strlen($rets_mgmt_process) > 10)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_process when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setRetsMgmtProcessItem($rets_mgmt_process_item)
    {
        if (is_null($rets_mgmt_process_item)) {
            array_push($this->openAPINullablesSetToNull, 'rets_mgmt_process_item');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rets_mgmt_process_item', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($rets_mgmt_process_item) && (mb_strlen($rets_mgmt_process_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_process_item when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 6.');
        }
    ...
    public function setReturnReason($return_reason)
    {
        ...
        if (!is_null($return_reason) && (mb_strlen($return_reason) > 3)) {
            throw new \InvalidArgumentException('invalid length for $return_reason when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setRetsMgmtProcessingBlock($rets_mgmt_processing_block)
    {
        ...
        if (!is_null($rets_mgmt_processing_block) && (mb_strlen($rets_mgmt_processing_block) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_processing_block when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustRetItmFollowUpActivity($cust_ret_itm_follow_up_activity)
    {
        ...
        if (!is_null($cust_ret_itm_follow_up_activity) && (mb_strlen($cust_ret_itm_follow_up_activity) > 4)) {
            throw new \InvalidArgumentException('invalid length for $cust_ret_itm_follow_up_activity when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setReturnsMaterialHasBeenReceived($returns_material_has_been_received)
    {
        ...
        if (!is_null($returns_material_has_been_received) && (mb_strlen($returns_material_has_been_received) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_material_has_been_received when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setReturnsRefundType($returns_refund_type)
    {
        ...
        if (!is_null($returns_refund_type) && (mb_strlen($returns_refund_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_refund_type when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setReturnsRefundProcgMode($returns_refund_procg_mode)
    {
        ...
        if (!is_null($returns_refund_procg_mode) && (mb_strlen($returns_refund_procg_mode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_refund_procg_mode when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setRetsProdValnIsSuspended($rets_prod_valn_is_suspended)
    {
        ...
        if (!is_null($rets_prod_valn_is_suspended) && (mb_strlen($rets_prod_valn_is_suspended) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_prod_valn_is_suspended when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setReturnsRefundExtent($returns_refund_extent)
    {
        ...
        if (!is_null($returns_refund_extent) && (mb_strlen($returns_refund_extent) > 3)) {
            throw new \InvalidArgumentException('invalid length for $returns_refund_extent when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setPrelimRefundIsDetermined($prelim_refund_is_determined)
    {
        ...
        if (!is_null($prelim_refund_is_determined) && (mb_strlen($prelim_refund_is_determined) > 1)) {
            throw new \InvalidArgumentException('invalid length for $prelim_refund_is_determined when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Gets returns_refund_rjcn_reason
     *
     * @return string|null
     */
    public function getReturnsRefundRjcnReason()
    {
        return $this->container['returns_refund_rjcn_reason'];
    }

    /**
     * Sets returns_refund_rjcn_reason
     *
     * @param string|null $returns_refund_rjcn_reason Rejection Reason for Credit Memo Request
     *
     * @return self
     */
    public function setReturnsRefundRjcnReason($returns_refund_rjcn_reason)
    {
        if (is_null($returns_refund_rjcn_reason)) {
            array_push($this->openAPINullablesSetToNull, 'returns_refund_rjcn_reason');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('returns_refund_rjcn_reason', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($returns_refund_rjcn_reason) && (mb_strlen($returns_refund_rjcn_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $returns_refund_rjcn_reason when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 2.');
        }

        $this->container['returns_refund_rjcn_reason'] = $returns_refund_rjcn_reason;
    ...
    public function setReplacementMaterial($replacement_material)
    {
        ...
        if (!is_null($replacement_material) && (mb_strlen($replacement_material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $replacement_material when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 40.');
        }
    ...
    public function setReplacementMaterialQtyUnit($replacement_material_qty_unit)
    {
        ...
        if (!is_null($replacement_material_qty_unit) && (mb_strlen($replacement_material_qty_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $replacement_material_qty_unit when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setReplacementMaterialIsRequested($replacement_material_is_requested)
    {
        ...
        if (!is_null($replacement_material_is_requested) && (mb_strlen($replacement_material_is_requested) > 1)) {
            throw new \InvalidArgumentException('invalid length for $replacement_material_is_requested when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setReplacementMatlSupplyingPlant($replacement_matl_supplying_plant)
    {
        ...
        if (!is_null($replacement_matl_supplying_plant) && (mb_strlen($replacement_matl_supplying_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $replacement_matl_supplying_plant when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setNextPlantForFollowUpActivity($next_plant_for_follow_up_activity)
    {
        ...
        if (!is_null($next_plant_for_follow_up_activity) && (mb_strlen($next_plant_for_follow_up_activity) > 4)) {
            throw new \InvalidArgumentException('invalid length for $next_plant_for_follow_up_activity when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setReturnsTransshipmentPlant($returns_transshipment_plant)
    {
        ...
        if (!is_null($returns_transshipment_plant) && (mb_strlen($returns_transshipment_plant) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_transshipment_plant when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if (!is_null($supplier) && (mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplierRetMatlAuthzn($supplier_ret_matl_authzn)
    {
        ...
        if (!is_null($supplier_ret_matl_authzn) && (mb_strlen($supplier_ret_matl_authzn) > 20)) {
            throw new \InvalidArgumentException('invalid length for $supplier_ret_matl_authzn when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 20.');
        }
    ...
    /**
     * Gets suplr_ret_matl_authzn_is_required
     *
     * @return string|null
     */
    public function getSuplrRetMatlAuthznIsRequired()
    {
        return $this->container['suplr_ret_matl_authzn_is_required'];
    }

    /**
     * Sets suplr_ret_matl_authzn_is_required
     *
     * @param string|null $suplr_ret_matl_authzn_is_required suplr_ret_matl_authzn_is_required
     *
     * @return self
     */
    public function setSuplrRetMatlAuthznIsRequired($suplr_ret_matl_authzn_is_required)
    {
        if (is_null($suplr_ret_matl_authzn_is_required)) {
            array_push($this->openAPINullablesSetToNull, 'suplr_ret_matl_authzn_is_required');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('suplr_ret_matl_authzn_is_required', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($suplr_ret_matl_authzn_is_required) && (mb_strlen($suplr_ret_matl_authzn_is_required) > 1)) {
            throw new \InvalidArgumentException('invalid length for $suplr_ret_matl_authzn_is_required when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }

        $this->container['suplr_ret_matl_authzn_is_required'] = $suplr_ret_matl_authzn_is_required;
    ...
    public function setCustomerRetMatlInspResultCode($customer_ret_matl_insp_result_code)
    {
        ...
        if (!is_null($customer_ret_matl_insp_result_code) && (mb_strlen($customer_ret_matl_insp_result_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_ret_matl_insp_result_code when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setNextFllwUpActivityForMatlInsp($next_fllw_up_activity_for_matl_insp)
    {
        ...
        if (!is_null($next_fllw_up_activity_for_matl_insp) && (mb_strlen($next_fllw_up_activity_for_matl_insp) > 4)) {
            throw new \InvalidArgumentException('invalid length for $next_fllw_up_activity_for_matl_insp when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setRetMatlInspResultCode($ret_matl_insp_result_code)
    {
        ...
        if (!is_null($ret_matl_insp_result_code) && (mb_strlen($ret_matl_insp_result_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $ret_matl_insp_result_code when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setProductIsInspectedAtCustSite($product_is_inspected_at_cust_site)
    {
        ...
        if (!is_null($product_is_inspected_at_cust_site) && (mb_strlen($product_is_inspected_at_cust_site) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_is_inspected_at_cust_site when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Gets cust_ret_matl_authzn
     *
     * @return string|null
     */
    public function getCustRetMatlAuthzn()
    {
        return $this->container['cust_ret_matl_authzn'];
    }

    /**
     * Sets cust_ret_matl_authzn
     *
     * @param string|null $cust_ret_matl_authzn cust_ret_matl_authzn
     *
     * @return self
     */
    public function setCustRetMatlAuthzn($cust_ret_matl_authzn)
    {
        if (is_null($cust_ret_matl_authzn)) {
            array_push($this->openAPINullablesSetToNull, 'cust_ret_matl_authzn');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cust_ret_matl_authzn', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($cust_ret_matl_authzn) && (mb_strlen($cust_ret_matl_authzn) > 20)) {
            throw new \InvalidArgumentException('invalid length for $cust_ret_matl_authzn when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 20.');
        }

        $this->container['cust_ret_matl_authzn'] = $cust_ret_matl_authzn;

        return $this;
    }

    /**
     * Gets crm_logical_system
     *
     * @return string|null
     */
    public function getCrmLogicalSystem()
    {
        return $this->container['crm_logical_system'];
    }

    /**
     * Sets crm_logical_system
     *
     * @param string|null $crm_logical_system crm_logical_system
     *
     * @return self
     */
    public function setCrmLogicalSystem($crm_logical_system)
    {
        if (is_null($crm_logical_system)) {
            array_push($this->openAPINullablesSetToNull, 'crm_logical_system');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('crm_logical_system', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($crm_logical_system) && (mb_strlen($crm_logical_system) > 10)) {
            throw new \InvalidArgumentException('invalid length for $crm_logical_system when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 10.');
        }

        $this->container['crm_logical_system'] = $crm_logical_system;

        return $this;
    }

    /**
     * Gets crm_object_uuid
     *
     * @return string|null
     */
    public function getCrmObjectUuid()
    {
        return $this->container['crm_object_uuid'];
    }

    /**
     * Sets crm_object_uuid
     *
     * @param string|null $crm_object_uuid crm_object_uuid
     *
     * @return self
     */
    public function setCrmObjectUuid($crm_object_uuid)
    {
        if (is_null($crm_object_uuid)) {
            array_push($this->openAPINullablesSetToNull, 'crm_object_uuid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('crm_object_uuid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($crm_object_uuid) && (mb_strlen($crm_object_uuid) > 32)) {
            throw new \InvalidArgumentException('invalid length for $crm_object_uuid when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 32.');
        }

        $this->container['crm_object_uuid'] = $crm_object_uuid;
     ...
     * @return string|null
     */
    public function getCrmObjectId()
    {
        return $this->container['crm_object_id'];
    }

    /**
     * Sets crm_object_id
     *
     * @param string|null $crm_object_id crm_object_id
     *
     * @return self
     */
    public function setCrmObjectId($crm_object_id)
    {
        if (is_null($crm_object_id)) {
            array_push($this->openAPINullablesSetToNull, 'crm_object_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('crm_object_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($crm_object_id) && (mb_strlen($crm_object_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $crm_object_id when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 10.');
        }

        $this->container['crm_object_id'] = $crm_object_id;

        return $this;
    }

    /**
     * Gets crm_object_type
     *
     * @return string|null
     */
    public function getCrmObjectType()
    {
        return $this->container['crm_object_type'];
    }

    /**
     * Sets crm_object_type
     *
     * @param string|null $crm_object_type crm_object_type
     *
     * @return self
     */
    public function setCrmObjectType($crm_object_type)
    {
        if (is_null($crm_object_type)) {
            array_push($this->openAPINullablesSetToNull, 'crm_object_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('crm_object_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($crm_object_type) && (mb_strlen($crm_object_type) > 10)) {
            throw new \InvalidArgumentException('invalid length for $crm_object_type when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 10.');
        }

        $this->container['crm_object_type'] = $crm_object_type;

        return $this;
    }

    /**
     * Gets rets_mgmt_itm_log_procg_status
     *
     * @return string|null
     */
    public function getRetsMgmtItmLogProcgStatus()
    {
        return $this->container['rets_mgmt_itm_log_procg_status'];
    }

    /**
     * Sets rets_mgmt_itm_log_procg_status
     *
     * @param string|null $rets_mgmt_itm_log_procg_status Logistical Processing Status of a Return
     *
     * @return self
     */
    public function setRetsMgmtItmLogProcgStatus($rets_mgmt_itm_log_procg_status)
    {
        if (is_null($rets_mgmt_itm_log_procg_status)) {
            array_push($this->openAPINullablesSetToNull, 'rets_mgmt_itm_log_procg_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rets_mgmt_itm_log_procg_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($rets_mgmt_itm_log_procg_status) && (mb_strlen($rets_mgmt_itm_log_procg_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_itm_log_procg_status when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }

        $this->container['rets_mgmt_itm_log_procg_status'] = $rets_mgmt_itm_log_procg_status;

        return $this;
    }

    /**
     * Gets rets_mgmt_itm_compn_procg_status
     *
     * @return string|null
     */
    public function getRetsMgmtItmCompnProcgStatus()
    {
        return $this->container['rets_mgmt_itm_compn_procg_status'];
    }

    /**
     * Sets rets_mgmt_itm_compn_procg_status
     *
     * @param string|null $rets_mgmt_itm_compn_procg_status Status of Returns Refund Determination
     *
     * @return self
     */
    public function setRetsMgmtItmCompnProcgStatus($rets_mgmt_itm_compn_procg_status)
    {
        if (is_null($rets_mgmt_itm_compn_procg_status)) {
            array_push($this->openAPINullablesSetToNull, 'rets_mgmt_itm_compn_procg_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rets_mgmt_itm_compn_procg_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($rets_mgmt_itm_compn_procg_status) && (mb_strlen($rets_mgmt_itm_compn_procg_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_itm_compn_procg_status when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }

        $this->container['rets_mgmt_itm_compn_procg_status'] = $rets_mgmt_itm_compn_procg_status;

        return $this;
    }

    /**
     * Gets rets_mgmt_itm_procg_status
     *
     * @return string|null
     */
    public function getRetsMgmtItmProcgStatus()
    {
        return $this->container['rets_mgmt_itm_procg_status'];
    }

    /**
     * Sets rets_mgmt_itm_procg_status
     *
     * @param string|null $rets_mgmt_itm_procg_status rets_mgmt_itm_procg_status
     *
     * @return self
     */
    public function setRetsMgmtItmProcgStatus($rets_mgmt_itm_procg_status)
    {
        if (is_null($rets_mgmt_itm_procg_status)) {
            array_push($this->openAPINullablesSetToNull, 'rets_mgmt_itm_procg_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rets_mgmt_itm_procg_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($rets_mgmt_itm_procg_status) && (mb_strlen($rets_mgmt_itm_procg_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rets_mgmt_itm_procg_status when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }

        $this->container['rets_mgmt_itm_procg_status'] = $rets_mgmt_itm_procg_status;
    ...
    public function setReturnsDocumentStatus($returns_document_status)
    {
        ...
        if (!is_null($returns_document_status) && (mb_strlen($returns_document_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_document_status when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setReturnsDocumentApprovalStatus($returns_document_approval_status)
    {
        ...
        if (!is_null($returns_document_approval_status) && (mb_strlen($returns_document_approval_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $returns_document_approval_status when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setSdProcessStatus($sd_process_status)
    {
        ...
        if (!is_null($sd_process_status) && (mb_strlen($sd_process_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $sd_process_status when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setReferenceSdDocument($reference_sd_document)
    {
        ...
        if (!is_null($reference_sd_document) && (mb_strlen($reference_sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceSdDocumentItem($reference_sd_document_item)
    {
        ...
        if (!is_null($reference_sd_document_item) && (mb_strlen($reference_sd_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document_item when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 6.');
        }
    ...
    public function setReferenceSdDocumentCategory($reference_sd_document_category)
    {
        ...
        if (!is_null($reference_sd_document_category) && (mb_strlen($reference_sd_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document_category when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 4.');
        }
    ...
    /**
     * Gets sd_document_rejection_status
     *
     * @return string|null
     */
    public function getSdDocumentRejectionStatus()
    {
        return $this->container['sd_document_rejection_status'];
    }

    /**
     * Sets sd_document_rejection_status
     *
     * @param string|null $sd_document_rejection_status Rejection Status (Item)
     *
     * @return self
     */
    public function setSdDocumentRejectionStatus($sd_document_rejection_status)
    {
        if (is_null($sd_document_rejection_status)) {
            array_push($this->openAPINullablesSetToNull, 'sd_document_rejection_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sd_document_rejection_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($sd_document_rejection_status) && (mb_strlen($sd_document_rejection_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_rejection_status when calling APICUSTOMERRETURNSRVACustomerReturnItemType., must be smaller than or equal to 1.');
        }

        $this->container['sd_document_rejection_status'] = $sd_document_rejection_status;
     ...
     * Gets to_partner
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToPartner|null
     */
     ...
     * Sets to_partner
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToPartner|null $to_partner to_partner
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToPricingElement|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToPricingElement|null $to_pricing_element to_pricing_element
     *
     * @return self
     */
    ...
    /**
     * Gets to_process_step
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToProcessStep|null
     */
    public function getToProcessStep()
    {
        return $this->container['to_process_step'];
    }

    /**
     * Sets to_process_step
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToProcessStep|null $to_process_step to_process_step
     *
     * @return self
     */
    public function setToProcessStep($to_process_step)
    {
        if (is_null($to_process_step)) {
            throw new \InvalidArgumentException('non-nullable to_process_step cannot be null');
        }
        $this->container['to_process_step'] = $to_process_step;
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToRelatedObject|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToRelatedObject|null $to_related_object to_related_object
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToScheduleLine|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToScheduleLine|null $to_schedule_line to_schedule_line
     *
     * @return self
     */
    ...
    /**
     * Gets to_serial_number
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToSerialNumber|null
     */
    public function getToSerialNumber()
    {
        return $this->container['to_serial_number'];
    }

    /**
     * Sets to_serial_number
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToSerialNumber|null $to_serial_number to_serial_number
     *
     * @return self
     */
    public function setToSerialNumber($to_serial_number)
    {
        if (is_null($to_serial_number)) {
            throw new \InvalidArgumentException('non-nullable to_serial_number cannot be null');
        }
        $this->container['to_serial_number'] = $to_serial_number;
     ...
     * Gets to_text
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToText|null
     */
     ...
     * Sets to_text
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVACustomerReturnItemTypeToText|null $to_text to_text
     *
     * @return self
     */
