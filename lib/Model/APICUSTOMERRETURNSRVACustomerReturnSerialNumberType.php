<?php
/**
 * APICUSTOMERRETURNSRVACustomerReturnSerialNumberType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APICUSTOMERRETURNSRVACustomerReturnSerialNumberType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnSerialNumberType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnSerialNumberType';
    ...
    */
    ...
    public function setCustomerReturn($customer_return)
    {
        ...
        if ((mb_strlen($customer_return) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_return when calling APICUSTOMERRETURNSRVACustomerReturnSerialNumberType., must be smaller than or equal to 10.');
        }
    ...
    public function setCustomerReturnItem($customer_return_item)
    {
        ...
        if ((mb_strlen($customer_return_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_item when calling APICUSTOMERRETURNSRVACustomerReturnSerialNumberType., must be smaller than or equal to 6.');
        }
    ...
    public function setSerialNumber($serial_number)
    {
        ...
        if ((mb_strlen($serial_number) > 18)) {
            throw new \InvalidArgumentException('invalid length for $serial_number when calling APICUSTOMERRETURNSRVACustomerReturnSerialNumberType., must be smaller than or equal to 18.');
        }
