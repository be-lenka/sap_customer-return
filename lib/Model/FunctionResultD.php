...
/**
 * FunctionResultD Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class FunctionResultD implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FunctionResult_d';
    ...
    protected static $openAPITypes = [
        'reject_approval_request' => '\BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVFunctionResult'
    ];
    ...
    protected static $setters = [
        'reject_approval_request' => 'setRejectApprovalRequest'
    ];
    ...
    protected static $getters = [
        'reject_approval_request' => 'getRejectApprovalRequest'
    ];
    ...
    {
        $this->setIfExists('reject_approval_request', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets reject_approval_request
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVFunctionResult|null
     */
    public function getRejectApprovalRequest()
    {
        return $this->container['reject_approval_request'];
    }

    /**
     * Sets reject_approval_request
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\APICUSTOMERRETURNSRVFunctionResult|null $reject_approval_request reject_approval_request
     *
     * @return self
     */
    public function setRejectApprovalRequest($reject_approval_request)
    {
        if (is_null($reject_approval_request)) {
            throw new \InvalidArgumentException('non-nullable reject_approval_request cannot be null');
        }
        $this->container['reject_approval_request'] = $reject_approval_request;
