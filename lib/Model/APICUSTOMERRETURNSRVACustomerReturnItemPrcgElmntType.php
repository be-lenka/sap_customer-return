<?php
/**
 * APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnItemPrcgElmntType';
    ...
    protected static $openAPITypes = [
        ...
        'cndn_is_relevant_for_invoice_list' => 'string',
        ...
        'factor_for_condition_basis_value' => '\BeLenka\SAP\CustomerReturn\Model\ConditionFactor',
        'structure_condition' => 'string',
        'period_factor_for_cndn_basis_value' => '\BeLenka\SAP\CustomerReturn\Model\ConditionFactor1',
    ...
    protected static array $openAPINullables = [
		...
		'cndn_is_relevant_for_invoice_list' => true,
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cndn_is_relevant_for_invoice_list']) && (mb_strlen($this->container['cndn_is_relevant_for_invoice_list']) > 1)) {
            $invalidProperties[] = "invalid value for 'cndn_is_relevant_for_invoice_list', the character length must be smaller than or equal to 1.";
        }
    ...
    public function setCustomerReturn($customer_return)
    {
        ...
        if ((mb_strlen($customer_return) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_return when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string|null $customer_return_item Condition item number
     *
     * @return self
     */
    public function setCustomerReturnItem($customer_return_item)
    {
        ...
        if ((mb_strlen($customer_return_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $customer_return_item when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 6.');
        }
    ...
    public function setPricingProcedureStep($pricing_procedure_step)
    {
        ...
        if ((mb_strlen($pricing_procedure_step) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_procedure_step when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setPricingProcedureCounter($pricing_procedure_counter)
    {
        ...
        if ((mb_strlen($pricing_procedure_counter) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_procedure_counter when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionType($condition_type)
    {
        ...
        if (!is_null($condition_type) && (mb_strlen($condition_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $condition_type when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 4.');
        }
    ...
    public function setPricingDateTime($pricing_date_time)
    {
        ...
        if (!is_null($pricing_date_time) && (mb_strlen($pricing_date_time) > 14)) {
            throw new \InvalidArgumentException('invalid length for $pricing_date_time when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 14.');
        }
    ...
    public function setConditionCalculationType($condition_calculation_type)
    {
        ...
        if (!is_null($condition_calculation_type) && (mb_strlen($condition_calculation_type) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_calculation_type when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionCurrency($condition_currency)
    {
        ...
        if (!is_null($condition_currency) && (mb_strlen($condition_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $condition_currency when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 5.');
        }
    ...
    public function setConditionQuantityUnit($condition_quantity_unit)
    {
        ...
        if (!is_null($condition_quantity_unit) && (mb_strlen($condition_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_quantity_unit when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionCategory($condition_category)
    {
        ...
        if (!is_null($condition_category) && (mb_strlen($condition_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_category when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setPricingScaleType($pricing_scale_type)
    {
        ...
        if (!is_null($pricing_scale_type) && (mb_strlen($pricing_scale_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $pricing_scale_type when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 1.');
        }
     ...
     *
     * @param string|null $cndn_is_relevant_for_invoice_list Condition for Invoice List
     *
     * @return self
     */
    public function setCndnIsRelevantForInvoiceList($cndn_is_relevant_for_invoice_list)
    {
        if (is_null($cndn_is_relevant_for_invoice_list)) {
            array_push($this->openAPINullablesSetToNull, 'cndn_is_relevant_for_invoice_list');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cndn_is_relevant_for_invoice_list', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($cndn_is_relevant_for_invoice_list) && (mb_strlen($cndn_is_relevant_for_invoice_list) > 1)) {
            throw new \InvalidArgumentException('invalid length for $cndn_is_relevant_for_invoice_list when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionOrigin($condition_origin)
    {
        ...
        if (!is_null($condition_origin) && (mb_strlen($condition_origin) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_origin when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setIsGroupCondition($is_group_condition)
    {
        ...
        if (!is_null($is_group_condition) && (mb_strlen($is_group_condition) > 1)) {
            throw new \InvalidArgumentException('invalid length for $is_group_condition when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionRecord($condition_record)
    {
        ...
        if (!is_null($condition_record) && (mb_strlen($condition_record) > 10)) {
            throw new \InvalidArgumentException('invalid length for $condition_record when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 10.');
        }
    ...
    public function setConditionSequentialNumber($condition_sequential_number)
    {
        ...
        if (!is_null($condition_sequential_number) && (mb_strlen($condition_sequential_number) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_sequential_number when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setTaxCode($tax_code)
    {
        ...
        if (!is_null($tax_code) && (mb_strlen($tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $tax_code when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 2.');
        }
    ...
    public function setWithholdingTaxCode($withholding_tax_code)
    {
        ...
        if (!is_null($withholding_tax_code) && (mb_strlen($withholding_tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_code when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 2.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 5.');
        }
    ...
    public function setConditionControl($condition_control)
    {
        ...
        if (!is_null($condition_control) && (mb_strlen($condition_control) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_control when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionInactiveReason($condition_inactive_reason)
    {
        ...
        if (!is_null($condition_inactive_reason) && (mb_strlen($condition_inactive_reason) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_inactive_reason when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionClass($condition_class)
    {
        ...
        if (!is_null($condition_class) && (mb_strlen($condition_class) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_class when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 1.');
        }
    ...
    public function setPrcgProcedureCounterForHeader($prcg_procedure_counter_for_header)
    {
        ...
        if (!is_null($prcg_procedure_counter_for_header) && (mb_strlen($prcg_procedure_counter_for_header) > 3)) {
            throw new \InvalidArgumentException('invalid length for $prcg_procedure_counter_for_header when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 3.');
        }
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\ConditionFactor|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\ConditionFactor|null $factor_for_condition_basis_value factor_for_condition_basis_value
     *
     * @return self
     */
    ...
    public function setStructureCondition($structure_condition)
    {
        ...
        if (!is_null($structure_condition) && (mb_strlen($structure_condition) > 1)) {
            throw new \InvalidArgumentException('invalid length for $structure_condition when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 1.');
        }
     ...
     *
     * @return \BeLenka\SAP\CustomerReturn\Model\ConditionFactor1|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturn\Model\ConditionFactor1|null $period_factor_for_cndn_basis_value period_factor_for_cndn_basis_value
     *
     * @return self
     */
    ...
    public function setPricingScaleBasis($pricing_scale_basis)
    {
        ...
        if (!is_null($pricing_scale_basis) && (mb_strlen($pricing_scale_basis) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_scale_basis when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionScaleBasisUnit($condition_scale_basis_unit)
    {
        ...
        if (!is_null($condition_scale_basis_unit) && (mb_strlen($condition_scale_basis_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_scale_basis_unit when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionScaleBasisCurrency($condition_scale_basis_currency)
    {
        ...
        if (!is_null($condition_scale_basis_currency) && (mb_strlen($condition_scale_basis_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $condition_scale_basis_currency when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 5.');
        }
    ...
    public function setVariantCondition($variant_condition)
    {
        ...
        if (!is_null($variant_condition) && (mb_strlen($variant_condition) > 26)) {
            throw new \InvalidArgumentException('invalid length for $variant_condition when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntType., must be smaller than or equal to 26.');
        }
