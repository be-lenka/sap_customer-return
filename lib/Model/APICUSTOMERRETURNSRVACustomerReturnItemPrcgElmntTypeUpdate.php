...
/**
 * APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturn
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURN_SRV.A_CustomerReturnItemPrcgElmntType-update';
    ...
    */
    ...
    public function setConditionType($condition_type)
    {
        ...
        if (!is_null($condition_type) && (mb_strlen($condition_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $condition_type when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setConditionCurrency($condition_currency)
    {
        ...
        if (!is_null($condition_currency) && (mb_strlen($condition_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $condition_currency when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntTypeUpdate., must be smaller than or equal to 5.');
        }
    ...
    public function setConditionQuantityUnit($condition_quantity_unit)
    {
        ...
        if (!is_null($condition_quantity_unit) && (mb_strlen($condition_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_quantity_unit when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APICUSTOMERRETURNSRVACustomerReturnItemPrcgElmntTypeUpdate., must be smaller than or equal to 5.');
        }
